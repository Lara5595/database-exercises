...
INSERT INTO albums (artist, record_name, release_date, sales, genre) VALUES
...
('Michael Jackson', 'Bad', 1987, 21.1, 'Pop,rhythm and blue, funk and rock'),
('Meat Loaf', 'Bat Out of Hell', 1977, 22, 'Hard Rock, glam rock'),
('Alanis Morissette', 'Jagged Little Pill', 1995, 25.4, 'Alternative rock'),
('Various artist', 'Dirty Dancing', 1987, 24.1, 'Pop,rock,R&B'),
...
('Dire Straits', 'Brothers in Arms', 1985, 21.1, 'Roots rock, blue rock, soft rock'),
